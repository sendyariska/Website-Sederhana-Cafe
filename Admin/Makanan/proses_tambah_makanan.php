        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, '../../Gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                  ...
                  if(!$result){
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='tampil_makanan.php';</script>";
                  }

            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya png, jpg atau jpeg.');window.location='tampil_makanan.php';</script>";
            }
}
