...
<html>
  ...
  <body bgcolor = "#ffd194">
    ...
    <center><a href="tambah_laporan.php">+ &nbsp; Tambah Laporan</a><center>
    <br/>
      ...
      ?>
       <tr>
          ...
          <td style="text-align: center"> 
              <a href="edit_laporan.php?id_laporan=<?php echo $row['id_laporan']; ?>">Edit</a> |
              <a href="hapus_laporan.php?id_laporan=<?php echo $row['id_laporan']; ?>" onclick="return confirm('Anda yakin akan menghapus minuman ini?')">Hapus</a>
          </td>
      </tr>
