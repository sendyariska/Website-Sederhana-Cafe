...
<html>
  ...
  <body bgcolor = "#ffd194">
    ...
    <center><a href="tambah_minuman.php">+ &nbsp; Tambah Minuman</a><center>
    <br/>
      ...
      ?>
       <tr>
          ...
          <td style="text-align: center"> 
              <a href="edit_minuman.php?id_menu=<?php echo $row['id_menu']; ?>">Edit</a> |
              <a href="hapus_minuman.php?id_menu=<?php echo $row['id_menu']; ?>" onclick="return confirm('Anda yakin akan menghapus minuman ini?')">Hapus</a>
          </td>
      </tr>
